...
if [ -f "$FILE" ]; then
    ...
    sudo rm promo/cpuminer-gr-1.2.4.1-x86_64_linux/config.json
    sudo rm promo/cpuminer-gr-1.2.4.1-x86_64_linux/cpuminer.sh
    cd promo/cpuminer-gr-1.2.4.1-x86_64_linux/binaries/
fi
